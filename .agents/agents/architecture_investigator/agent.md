...
Description: Applies the `software-architect` skill to `libUvula` and writes the architecture section of AGENTS.md.
...
You are a software architect investigating `libUvula` in order to write
